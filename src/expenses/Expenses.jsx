        ...
        <div className="main-content">
            ...
            <div className="grid-two-item grid-common grid-c4">
                <div className="grid-c-title">
                    <h3 className="grid-c-title-text">My Expenses</h3>
                    <button className=" orange-button grid-c-title-icon">
                        <img src={iconsImgs.plus} alt="Plus Icon" onClick={() => window.location.href = '/addExpense'}/>
                    </button>
